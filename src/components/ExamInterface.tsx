...
export default function ExamInterface({ examData, onLogout, onSubmitTest }: ExamInterfaceProps) {
        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 pt-2">
              <button onClick={handleFinalSubmit} className="w-full bg-[#1C2A39] hover:bg-slate-800 text-white font-semibold py-3.5 rounded-xl shadow-md transition-colors">
                Submit Test
              </button>
            </div>
          </div>
